...
class TeamModel(nn.Module):
    def __init__(self):
        ...
        self.player_outputs = []
        self.roster = []
        encoder_layers = TransformerEncoderLayer(d_model=PLAYER_MODEL_OUTPUT_N, nhead=4, dropout=WINNER_DROP_RATE)
...
class GameWinnerModel(nn.Module):
    def __init__(self):
        super(GameWinnerModel, self).__init__()
        self.game = {}
